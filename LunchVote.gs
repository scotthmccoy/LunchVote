...
function LUNCHVOTE_RANK() {
    ...
    for (var i=1; i<arguments.length; i++) {
        ...
        for (var j=0; j<legalCandidates.length; j++) {
            var candidate = legalCandidates[j][0];
    ...
    //Run the election
    var strBallotsExpected = JSON.stringify(shulzeWikiExampleTestBallots());
    var strBallotsActual = JSON.stringify(ballots);
    
    Logger.log(strBallotsExpected);
    Logger.log(strBallotsActual);
...
function shulzeWikiExampleTestBallotsRanks() {
    ...
    for (x=1; x<=5; x++) {
        ballots.push([["1"], ["4"], ["5"], ["3"], ["2"]]);
    }
    
    for (x=1; x<=8; x++) {
        ballots.push([["2"], ["5"], ["4"], ["1"], ["3"]]);
    }
    
    for (x=1; x<=3; x++) {
        ballots.push([["3"], ["1"], ["2"], ["5"], ["4"]]);
    }
    
    for (x=1; x<=7; x++) {
        ballots.push([["3"], ["1"], ["5"], ["2"], ["4"]]);
    }
    ...
    for (x=1; x<=7; x++) {
        ballots.push([["4"], ["3"], ["5"], ["2"], ["1"]]);
    }
    
    for (x=1; x<=8; x++) {
        ballots.push([["5"], ["2"], ["1"], ["4"], ["3"]]);
    }
